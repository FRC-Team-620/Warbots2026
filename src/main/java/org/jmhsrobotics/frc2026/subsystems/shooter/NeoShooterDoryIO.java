...
public class NeoShooterDoryIO implements ShooterIO {
  private SparkMax motor = new SparkMax(Constants.DoryCAN.kShooterMotorID, MotorType.kBrushless);
  private RelativeEncoder encoder;
  private SparkMaxConfig motorConfig;
  private SparkClosedLoopController pidController;
  private double velocityRPM;

  public NeoShooterDoryIO() {
