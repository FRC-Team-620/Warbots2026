...
import static org.jmhsrobotics.frc2026.util.PhoenixUtil.*;
...
public class ModuleIOTalonFX implements ModuleIO {
  ...
  public ModuleIOTalonFX(
    ...
    cancoder = new Canandmag(constants.EncoderId);

    // Configure drive motor
    var driveConfig = constants.DriveMotorInitialConfigs;
    driveConfig.MotorOutput.NeutralMode = NeutralModeValue.Brake;
    driveConfig.Slot0 = new Slot0Configs().withKP(0.7).withKI(0).withKD(0).withKS(0).withKV(0.124);
  ...
  public void updateInputs(ModuleIOInputs inputs) {
    ...
    inputs.turnAbsolutePosition = Rotation2d.fromRotations(cancoder.getAbsPosition());
