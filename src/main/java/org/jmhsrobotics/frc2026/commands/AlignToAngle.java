...
public class AlignToAngle extends Command {
  ...
  // TODO allow arb angle
  public AlignToAngle(Drive drive, ControlBoard control) {
    this.drive = drive;
  ...
  public void execute() {
    ...
    double thetaOutput =
        thetaController.calculate(drive.getPose().getRotation().getDegrees(), isFlipped ? 0 : 180);
  ...
  // private double getAutoAlignDistance(Translation2d goalTrans, Translation2d robotTranslation) {
