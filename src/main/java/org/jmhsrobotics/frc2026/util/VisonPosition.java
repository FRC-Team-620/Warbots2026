...
public class VisonPosition {
  public static final Pose3d OFFSET =
  ...
  public static Transform3d setCalibration(double x, double y, double z, Quaternion quaternion) {
    var calibration = new Transform3d(x, y, z, new Rotation3d(quaternion));
  ...
  // TODO: Add Javadocs
  public static Pose3d computeCameraPositionFromTarget(
      Pose3d calTargetFromRobot, Transform3d measuredTagPos) {
    // Given a Known tag location from the center of the robot. IE a calibration rig, and the
    // measured (Camera Rel) position of the april tag
